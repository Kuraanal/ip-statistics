...
// Adresses UP
$query = "SELECT count(*) AS num FROM adr_ip WHERE adr_ip_lan = '$lan_id' AND adr_ip_time >= $time_up";
...
// Adresses MIDDLE
$query = "SELECT count(*) AS num FROM adr_ip WHERE adr_ip_lan = '$lan_id' AND adr_ip_time < $time_up AND adr_ip_time >= $time_middle";
$sql = mysql_query($query) or die(mysql_error().'<br>');
while($data = mysql_fetch_assoc($sql))
{
$ipmiddle = $data['num'];
...
// Adresses RED
$query = "SELECT count(*) AS num FROM adr_ip WHERE adr_ip_lan = '$lan_id' AND adr_ip_time < $time_middle AND adr_ip_time >= $time_red";
$sql = mysql_query($query) or die(mysql_error().'<br>');
while($data = mysql_fetch_assoc($sql))
{
$ipred = $data['num'];
...
// Adresses DOWN
$query = "SELECT count(*) AS num FROM adr_ip WHERE adr_ip_lan = '$lan_id' AND adr_ip_time < $time_red";
$sql = mysql_query($query) or die(mysql_error().'<br>');
while($data = mysql_fetch_assoc($sql))
{
$ipdown = $data['num'];
